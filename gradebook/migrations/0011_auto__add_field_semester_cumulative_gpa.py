...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Semester.cumulative_gpa'
        db.add_column(u'gradebook_semester', 'cumulative_gpa',
                      self.gf('django.db.models.fields.FloatField')(default=-1.0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Semester.cumulative_gpa'
        db.delete_column(u'gradebook_semester', 'cumulative_gpa')
