...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Semester.hours_planned'
        db.add_column(u'gradebook_semester', 'hours_planned',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Semester.hours_planned'
        db.delete_column(u'gradebook_semester', 'hours_planned')
