...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Semester.cumulative_hours_passed'
        db.add_column(u'gradebook_semester', 'cumulative_hours_passed',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Semester.cumulative_hours_passed'
        db.delete_column(u'gradebook_semester', 'cumulative_hours_passed')
