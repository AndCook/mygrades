...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Semester.hours_passed'
        db.add_column(u'gradebook_semester', 'hours_passed',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Semester.gpa_hours'
        db.add_column(u'gradebook_semester', 'gpa_hours',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)
        ...
        # Adding field 'Semester.final_gpa'
        db.add_column(u'gradebook_semester', 'final_gpa',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=4, decimal_places=3),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'gradebook_semester', 'hours_passed')
