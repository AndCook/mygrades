...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Semester.start_date'
        db.add_column(u'gradebook_semester', 'start_date',
                      self.gf('django.db.models.fields.DateField')(default=datetime.date.today),
                      keep_default=False)

        # Adding field 'Semester.end_date'
        db.add_column(u'gradebook_semester', 'end_date',
                      self.gf('django.db.models.fields.DateField')(default=datetime.date.today),
                      keep_default=False)


        # Changing field 'Semester.name'
        db.alter_column(u'gradebook_semester', 'name', self.gf('django.db.models.fields.CharField')(max_length=32))

    def backwards(self, orm):
        # Deleting field 'Semester.start_date'
        db.delete_column(u'gradebook_semester', 'start_date')

        # Deleting field 'Semester.end_date'
        db.delete_column(u'gradebook_semester', 'end_date')


        # Changing field 'Semester.name'
        db.alter_column(u'gradebook_semester', 'name', self.gf('django.db.models.fields.CharField')(max_length=200))
