...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Course.final_grade'
        db.add_column(u'gradebook_course', 'final_grade',
                      self.gf('django.db.models.fields.CharField')(default='#', max_length=2),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Course.final_grade'
        db.delete_column(u'gradebook_course', 'final_grade')
