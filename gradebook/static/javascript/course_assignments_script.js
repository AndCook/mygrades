$(document).ready(function() {
    ...
    edit_grade_unknown_button.on('checked',
        function () {
            edit_points_earned_input.disable();
        });
    edit_grade_unknown_button.on('unchecked',
        function () {
            edit_points_earned_input.enable();
        });
    ...
    categories_assignments_wrapper.on('click', '#edit_assignment_button', function() {
        ...
        edit_category_tree.jqxTree('selectItem', $('#' + current_category));

        var assignment_points = edit_assignment_form.find('#assignment_points').text().split(' / ');
        var points_earned = assignment_points[0];
        if (points_earned === '?') {
        ...
        edit_total_points_input.val(assignment_points[1]);
